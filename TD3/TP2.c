...
/**
* \file TP2.c
* \brief Programme qui affiche les donnés d'une tableau
* \author TANG YUKE
* \version 1.0
* \date 17 octobre 2016

* \fn void afficher_base(t_personne* amis, int nb_amis)
* \brief fonction qui affiche les bases
* \param sex cette chaine de caractère est pour afficher homme ou femme

* \fn void afficher_nombre_fh(t_personne* amis, int nb_amis)
* \brief affiche le nombre de hommes et femmes

* \fn void afficher_anniv(t_personne* amis, int nb_amis)
* \brief affiche l'anniversaire d'un personne

* \fn void afficher_cadet(t_personne* amis, int nb_amis)
* \brief affiche le plus jeune

* \fn void ajouter_personne(t_personne* amis, int* nb_amis)
* \brief ajouter une personne dans la liste

* \struct t_date
* \brief structure pour définir le date

* \struct t_personne
* \brief structure pour définir une personne

* \enum t_sexe
* \brief enum pour définir le sex
*/
